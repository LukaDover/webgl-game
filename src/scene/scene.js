...
export class Scene {
    ...
    initScene(world) {
        //streetSide
        let building1 = new StationaryObject('./blender/scene/newSide.obj');  //'./blender/textured-streetSide2.obj'
        building1.getTexture('./blender/textures/facade.jpg');
        building1.initializeBuffers();
        let building1Body = new CANNON.Body({
            mass: 0, // mass == 0 makes the body static
            position: new CANNON.Vec3(0, 30, -20),
        });
        let building1Shape = new CANNON.Box(new CANNON.Vec3(200, 0.1, 10));
        ...
        //StreetSide
        let building2 = new StationaryObject('./blender/scene/newSide.obj');
        building2.getTexture('./blender/textures/facade.jpg');
        building2.initializeBuffers();
        let building2Body = new CANNON.Body({
            mass: 0, // mass == 0 makes the body static
            position: new CANNON.Vec3(0, -30, -20),
        });
        let building2Shape = new CANNON.Box(new CANNON.Vec3(200, 0.1, 10));
        ...
        //StreetEnd
        let streetEnd = new StationaryObject('./blender/scene/streetEnd.obj');
        streetEnd.getTexture('./blender/textures/facade.jpg');
        streetEnd.initializeBuffers();
        let streetEndBody = new CANNON.Body({
            mass: 0, // mass == 0 makes the body static
            position: new CANNON.Vec3(-200, 0, -20),
        });
        let streetEndShape = new CANNON.Box(new CANNON.Vec3(0.1, 60, 10));
        ...
        //StreetEnd
        let streetEnd2 = new StationaryObject('./blender/scene/streetEnd.obj');
        streetEnd2.getTexture('./blender/textures/facade.jpg');
        streetEnd2.initializeBuffers();
        let streetEndBody2 = new CANNON.Body({
            mass: 0, // mass == 0 makes the body static
            position: new CANNON.Vec3(200, 0, -20),
        });
        let streetEndShape2 = new CANNON.Box(new CANNON.Vec3(0.1, 60, 10));
